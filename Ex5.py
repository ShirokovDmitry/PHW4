...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("filehw1.txt", create_str(koef1))
write_file("filehw2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('filehw1.txt', 'r') as data:
    st1 = data.readlines()
with open('filehw2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("filesum.txt", create_str(lst_new))
with open('filesum.txt', 'r') as data:
    st3 = data.readlines()
